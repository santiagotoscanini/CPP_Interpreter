...
QId :: { QId }
QId : Id { AbsCPP.QId $1 }
    | Id '<' ListType '>' { AbsCPP.QIdT $1 $3 }
QConst :: { QConst }
QConst : ListQId { AbsCPP.QConst $1 }
ListQId :: { [QId] }
...
Exp15 :: { Exp }
Exp15 : QConst { AbsCPP.EQct $1 }
      | Id '[' Exp ']' { AbsCPP.EArr $1 $3 }
      | Id '(' ListExp ')' { AbsCPP.EApp $1 $3 }
      | Exp16 { $1 }
Exp14 :: { Exp }
Exp14 : Exp15 '.' Exp15 { AbsCPP.EPEstr $1 $3 }
      | Exp15 '->' Exp15 { AbsCPP.EProy $1 $3 }
      | Exp15 '++' { AbsCPP.EPIncr $1 }
      | Exp15 '--' { AbsCPP.EPDecr $1 }
      | '*' Exp15 { AbsCPP.EPDecr $2 }
      | Exp15 { $1 }
Exp13 :: { Exp }
...
Exp2 : Exp3 '=' Exp2 { AbsCPP.EAss $1 $3 }
     ...
     | Exp3 { $1 }
Exp1 :: { Exp }
Exp1 : 'throw' Exp2 { AbsCPP.EExcp $2 } | Exp2 { $1 }
Exp :: { Exp }
Exp : Exp1 { $1 }
Exp5 :: { Exp }
Exp5 : Exp6 { $1 }
...
ListExp : {- empty -} { [] }
        | Exp { (:[]) $1 }
        | Exp ',' ListExp { (:) $1 $3 }
BuilInType :: { BuilInType }
BuilInType : 'bool' { AbsCPP.BuilInType_bool }
           | 'int' { AbsCPP.BuilInType_int }
           | 'double' { AbsCPP.BuilInType_double }
           | 'void' { AbsCPP.BuilInType_void }
Type :: { Type }
Type : BuilInType { AbsCPP.TypeB $1 }
     | QConst { AbsCPP.TypeQ $1 }
     | Type '&' { AbsCPP.TypeP $1 }
ListType :: { [Type] }
