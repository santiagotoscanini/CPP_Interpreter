...
instance Print Def where
  prt i e = case e of
    ...
    DFunSBdy type_ id args -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), doc (showString ";")])
    DFunInline type_ id args stms -> prPrec i 0 (concatD [doc (showString "inline"), prt 0 type_, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), doc (showString "{"), prt 0 stms, doc (showString "}")])
    DFunSBdyIL type_ id args -> prPrec i 0 (concatD [doc (showString "inline"), prt 0 type_, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), doc (showString ";")])
    DUs qconst -> prPrec i 0 (concatD [doc (showString "using"), prt 0 qconst, doc (showString ";")])
    DType type_ id -> prPrec i 0 (concatD [doc (showString "typedef"), prt 0 type_, prt 0 id, doc (showString ";")])
    DDecls decl -> prPrec i 0 (concatD [prt 0 decl])
    DStruct id decls -> prPrec i 0 (concatD [doc (showString "struct"), prt 0 id, doc (showString "{"), prt 0 decls, doc (showString "}"), doc (showString ";")])
  prtList _ [] = concatD []
...
instance Print Decl where
  prt i e = case e of
    Decl type_ ids -> prPrec i 0 (concatD [prt 0 type_, prt 0 ids, doc (showString ";")])
...
instance Print Stm where
  prt i e = case e of
    ...
    SDecls decl -> prPrec i 0 (concatD [prt 0 decl])
    ...
    SDoWhile stm1 exp stm2 -> prPrec i 0 (concatD [doc (showString "do"), prt 0 stm1, doc (showString "while"), doc (showString "("), prt 0 exp, doc (showString ")"), prt 0 stm2])
    ...
    SFor decl exp1 exp2 stm -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 decl, prt 0 exp1, doc (showString ";"), prt 0 exp2, doc (showString ")"), prt 0 stm])
    SType type_ id -> prPrec i 0 (concatD [doc (showString "typedef"), prt 0 type_, prt 0 id, doc (showString ";")])
    SConst type_ exp -> prPrec i 0 (concatD [doc (showString "const"), prt 0 type_, prt 2 exp, doc (showString ";")])
    SStruct id decls -> prPrec i 0 (concatD [doc (showString "struct"), prt 0 id, doc (showString "{"), prt 0 decls, doc (showString "}"), doc (showString ";")])
  prtList _ [] = concatD []
  prtList _ (x:xs) = concatD [prt 0 x, prt 0 xs]
...
instance Print QId where
  prt i e = case e of
    ...
    QIdT id types -> prPrec i 0 (concatD [prt 0 id, doc (showString "<"), prt 0 types, doc (showString ">")])
  prtList _ [x] = concatD [prt 0 x]
  prtList _ (x:xs) = concatD [prt 0 x, doc (showString "::"), prt 0 xs]

instance Print QConst where
  prt i e = case e of
    QConst qids -> prPrec i 0 (concatD [prt 0 qids])
...
instance Print Exp where
  prt i e = case e of
    ...
    EQct qconst -> prPrec i 15 (concatD [prt 0 qconst])
    EArr id exp -> prPrec i 15 (concatD [prt 0 id, doc (showString "["), prt 0 exp, doc (showString "]")])
    EApp id exps -> prPrec i 15 (concatD [prt 0 id, doc (showString "("), prt 0 exps, doc (showString ")")])
    EPEstr exp1 exp2 -> prPrec i 14 (concatD [prt 15 exp1, doc (showString "."), prt 15 exp2])
    EProy exp1 exp2 -> prPrec i 14 (concatD [prt 15 exp1, doc (showString "->"), prt 15 exp2])
    ...
    ERest exp1 exp2 -> prPrec i 12 (concatD [prt 12 exp1, doc (showString "%"), prt 13 exp2])
    ...
    EMinAss exp1 exp2 -> prPrec i 2 (concatD [prt 3 exp1, doc (showString "-="), prt 2 exp2])
    EAddAss exp1 exp2 -> prPrec i 2 (concatD [prt 3 exp1, doc (showString "+="), prt 2 exp2])
    ...
    EExcp exp -> prPrec i 1 (concatD [doc (showString "throw"), prt 2 exp])
...
instance Print BuilInType where
  prt i e = case e of
    BuilInType_bool -> prPrec i 0 (concatD [doc (showString "bool")])
    BuilInType_int -> prPrec i 0 (concatD [doc (showString "int")])
    BuilInType_double -> prPrec i 0 (concatD [doc (showString "double")])
    BuilInType_void -> prPrec i 0 (concatD [doc (showString "void")])

instance Print Type where
  prt i e = case e of
    TypeB builintype -> prPrec i 0 (concatD [prt 0 builintype])
    TypeQ qconst -> prPrec i 0 (concatD [prt 0 qconst])
    TypeP type_ -> prPrec i 0 (concatD [prt 0 type_, doc (showString "&")])
  prtList _ [x] = concatD [prt 0 x]
  prtList _ (x:xs) = concatD [prt 0 x, doc (showString ","), prt 0 xs]
